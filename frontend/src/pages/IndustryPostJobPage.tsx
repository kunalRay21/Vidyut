...
import { PostOpportunityForm } from '../features/industry/components/PostOpportunityForm';
import { Link } from 'react-router-dom';
import { Users, FilePlus } from 'lucide-react';
import { FadeIn } from '../components/animations/FadeIn';

export const IndustryPostJobPage: React.FC = () => {
  return (
      ...
      <FadeIn delay={100}>
        <header className="mb-8 flex justify-between items-end border-b border-gray-200 pb-6">
          ...
          <div className="flex gap-3">
            <Link to="/industry/talent" className="flex items-center gap-2 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 px-4 py-2 rounded-md font-medium transition-colors">
