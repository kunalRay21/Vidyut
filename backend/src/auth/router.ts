...
router.post('/register', async (req: Request, res: Response) => {
  ...
  const { email, password, full_name, institution, degree, academic_branch_id, year_of_study, interests } = parseResult.data;
  ...
  try {
    ...
    try {
      ...
      await pool.query(
        `INSERT INTO student_profiles (id, user_id, full_name, institution, degree, academic_branch_id, year_of_study, interests)
         VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`,
        [profileId, userId, full_name, institution, degree, resolvedBranchId, year_of_study, interests]
      );
    } catch (dbErr: any) {
