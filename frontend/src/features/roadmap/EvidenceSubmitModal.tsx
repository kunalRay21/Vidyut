    ...
    <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-200">
        <div className="flex justify-between items-center p-5 border-b border-gray-100">
          ...
          <button onClick={onClose} className="p-1.5 rounded-lg text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition cursor-pointer">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="url"
                required
                className="pl-10 w-full border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-1 focus:ring-saffron focus:border-saffron text-gray-900 text-sm bg-white"
          ...
          <div>
            ...
            <textarea
              className="w-full border border-gray-300 rounded-xl py-2.5 px-3 focus:ring-1 focus:ring-saffron focus:border-saffron text-gray-900 text-sm bg-white"
              rows={3}
          ...
          <button 
            type="submit"
            className="w-full btn-saffron py-2.5 px-4 text-sm font-semibold rounded-xl flex items-center justify-center gap-2 shadow-sm cursor-pointer"
          >
