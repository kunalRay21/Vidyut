/**
 * Vidyut AI Fluency & Augmented Engineering Types
 * Measures how effectively and safely a developer collaborates with AI coding models without succumbing to hallucinations.
 */
...
export interface AIFluencyEvaluation {
  ...
  hallucinationCatchScore: number; // 0 - 35
  promptPrecisionScore: number; // 0 - 25
  codeVerificationScore: number; // 0 - 25
  refinementVelocityScore: number; // 0 - 15
